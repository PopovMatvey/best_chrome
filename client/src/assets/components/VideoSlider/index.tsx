...
// import { CarouseVideolItem, CarouseVideolItem as SliderlItem } from "./SliderlItem";
import arrorBack from "./images/arrow-back.png";
import arrorNext from "./images/arrow-next.png";
import { CarouselVideolItem } from "./SliderlItem";

// Слайдер Видео
export const VideoSlider = ({ items }: any) => {
    ...
    <div className="carousel">
      ...
      >
        {items.map((item: any, i: any) => {
          return <CarouselVideolItem key={i++} item={item} width={"100%"} />;
        })}
      </div>
